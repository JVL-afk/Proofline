...
REQUIRED_FILES = (
    ...
    "pyproject.toml",
    "uv.lock",
    "scripts/generate_m67_consolidated_owner_approval.py",
    "scripts/generate_m67_seed_source_package.py",
    "scripts/create_m67_terraform_plan_record.py",
    "apps/README.md",
    "services/README.md",
    "workers/README.md",
    "packages/README.md",
    ...
    "docs/adr/0075-terraform-phase1-provisioning-and-state.md",
    ...
    "docs/readiness/m6.7-authorization/discovery-signature.template.json",
    "docs/readiness/m6.7-authorization/a17-qualified-review.template.json",
    "docs/readiness/m6.7-authorization/a17-attorney-result-2026-08-21.json",
    ...
    "docs/readiness/m6.7-authorization/phase1-retention-policy-v1.json",
    "docs/readiness/m6.7-authorization/phase1-counsel-controls.md",
    "docs/readiness/m6.7-authorization/seed-and-selection-policy.md",
    "docs/readiness/m6.7-authorization/role-assignments.template.json",
    "docs/readiness/m6.7-authorization/role-assignments.predeployment.json",
    "docs/readiness/m6.7-authorization/consolidated-owner-approval-2026-08-21.json",
    "docs/readiness/m6.7-authorization/owner-input-consolidation.json",
    "docs/readiness/m6.7-authorization/generated-seed-source-package.template.json",
    "docs/readiness/m6.7-authorization/texas-statutory-provenance-2026-08-21.json",
    ...
    "infra/terraform/phase1/README.md",
    "infra/terraform/phase1/.terraform.lock.hcl",
    "infra/terraform/phase1/backend.hcl.example",
    "infra/terraform/phase1/backend.tf",
    "infra/terraform/phase1/compute.tf",
    "infra/terraform/phase1/database.tf",
    "infra/terraform/phase1/kms.tf",
    "infra/terraform/phase1/network.tf",
    "infra/terraform/phase1/observability.tf",
    "infra/terraform/phase1/outputs.tf",
    "infra/terraform/phase1/providers.tf",
    "infra/terraform/phase1/storage.tf",
    "infra/terraform/phase1/terraform.tfvars.example",
    "infra/terraform/phase1/variables.tf",
    "infra/terraform/phase1/versions.tf",
    "infra/terraform/modules/phase1-identifiers/main.tf",
    "infra/terraform/modules/phase1-identifiers/outputs.tf",
    "infra/terraform/modules/phase1-identifiers/variables.tf",
    ...
    "infra/terraform/registry/README.md",
    "infra/terraform/registry/main.tf",
    "infra/terraform/registry/outputs.tf",
    "infra/terraform/registry/providers.tf",
    ...
    "docs/readiness/m6.7-deployment/worker-registry-plan-review-2026-08-21.json",
    ...
    "docs/readiness/m6.7-deployment/aws-cli-sso-setup.md",
    "infra/container/phase1-worker/README.md",
    "infra/container/phase1-worker/image-evidence.template.json",
