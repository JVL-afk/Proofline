...
| A-16 | Outreach in MVP | Manual copy/export of drafts only | Open | Unassigned | ADR-0031 keeps M5 content-only with no copy/export; product/legal decision still required |
