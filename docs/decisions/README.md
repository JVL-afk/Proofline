...
| A-10 | Model/search providers | Approve vendors, regions, data terms, budgets, and fallbacks | Deferred | Product/architecture owners | Live AI disabled for M2 by ADR-0010 |
