"""One-shot entry point that materialises and writes one v3 (@4) sampled-slot approval.

Mirrors :mod:`authority_materialization_main` but for
AUTHORIZE_SLOTS07_24_PHASE1_M1_V2_PERSONALIZATION_V2_EXECUTION: the owner authority
is the immutable reviewed gate proposal (sha256
41cf105feb2ab1b21038803583867d56ea28e0a3dc99f46e5df91f7f66998251) and the
EXECUTION_READY package that incorporates it
...
def _materialize(args: argparse.Namespace) -> int:
    ...
    inputs = MaterializationInputsV3(
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Materialise one v3 (Slots 07-24) sampled-slot approval."
    )
